                ...
                VStack(alignment: .leading) {
                    ...
                    NavigationLink {
                        ...
                        Map(position: $cameraPosition) {
                            Annotation(
                                predator.name, coordinate: predator.location
                            ) {
                    ...
                    Text("Read More:")
                    Link(
                        predator.link, destination: URL(string: predator.link)!
...
#Preview {
    ...
    NavigationStack {
        PredatorDetail(
            predator: predators.apexPredators[number],
            cameraPosition: .camera(
                MapCamera(
                    centerCoordinate: predators.apexPredators[number].location,
                    distance: 30000))
        )
